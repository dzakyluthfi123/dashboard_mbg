      ...
      <div className="min-h-screen bg-gray-100 dark:bg-gray-950 p-4 md:p-6">
        <div className="grid grid-cols-12 gap-4 md:gap-6">
          ...
          <div className="col-span-12">
            <div className="bg-gray-50 dark:bg-gray-900 rounded-xl p-6 shadow-md border border-gray-200 dark:border-gray-800">
          ...
          <div className="col-span-12 grid grid-cols-12 gap-4 md:gap-6">
            ...
            <div className="col-span-12 xl:col-span-4 space-y-4 md:space-y-6">
              {/* Menu Hari Ini */}
              <div className="bg-gray-50 dark:bg-gray-900 rounded-xl p-5 shadow-md border border-gray-200 dark:border-gray-800">
                ...
                <div className="space-y-5">
                  ...
                  <div className="flex gap-4">
                    <div className="w-20 h-20 rounded-lg overflow-hidden bg-gray-200 dark:bg-gray-800">
                      <img
              ...
              <div className="bg-gray-50 dark:bg-gray-900 rounded-xl p-5 shadow-md border border-gray-200 dark:border-gray-800">
                <div className="flex justify-between items-center mb-4">
                  ...
                  <div className="text-xs text-gray-500 border border-gray-200 dark:border-gray-700 rounded-lg px-3 py-1">
                    Start Date
                  </div>
                </div>

                <div className="flex justify-between text-sm font-semibold text-gray-600 dark:text-gray-300 pb-2 border-b border-gray-200 dark:border-gray-700">
            ...
            <div className="col-span-12 xl:col-span-5">
              <div className="bg-gray-50 dark:bg-gray-900 rounded-xl p-5 shadow-md border border-gray-200 dark:border-gray-800 h-full">
                <div className="flex justify-between items-center mb-4">
                ...
                <div className="grid grid-cols-12 text-xs font-semibold text-gray-600 dark:text-gray-300 pb-2 border-b border-gray-200 dark:border-gray-700">
                ...
                <div className="mt-3 space-y-3 text-sm">
                  {[
                    ...
                    <div
                      key={idx}
                      className="grid grid-cols-12 items-center border-b border-gray-200 dark:border-gray-700 pb-2"
                    >
            ...
            <div className="col-span-12 xl:col-span-3">
              <div className="bg-gray-50 dark:bg-gray-900 rounded-xl p-5 shadow-md border border-gray-200 dark:border-gray-800 h-full flex flex-col">
                <div className="flex justify-between items-center mb-4">
                  <div className="flex items-center gap-2">
                    <h3 className="font-bold text-gray-800 dark:text-white">
                      Chat
